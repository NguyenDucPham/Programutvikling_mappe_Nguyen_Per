...
public class KontrollerJobj {
    ...
    private void initialize() {
        ...
        String last = null;
        InnlastingJobjThread test= new InnlastingJobjThread();
        try {
            last=test.call();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    protected void arrReg(ActionEvent event) {
        ...
        try {
            ...
            Beskjed.visVarsel(Alert.AlertType.ERROR, registrer, "Feil!", "Fant ikke klasse");
            return;
        }
    }
    ...
    protected void registrerSalg(ActionEvent event){
        ...
        try {
            endreBillett.billettSolgt("jobj", x);
        } catch (IOException e) {
    ...
    protected void slettArrangement(ActionEvent event){
        ...
        try{
            ...
            Beskjed.visVarsel(Alert.AlertType.ERROR, slett, "Feil!", "Fant ingen klasse");
            return;
        }
